...
<head>
    ...
    <style>
        .msg-a { background: #1a1d23; border-left: 3px solid #0d6efd; }
        .msg-b { background: #1a1d23; border-left: 3px solid #6c757d; }
        .msg-staff-view { background: #1a1d23; border-left: 3px solid #dc3545; }
    </style>
</head>
<body>
    ...
    <?php if ($viewUserA && $viewUserB && !empty($viewUsers)): ?>
        ...
        <div class="card mb-4">
            <div class="card-header fw-bold d-flex justify-content-between">
                <span>
                    <a href="/projet/user/profile.php?id=<?= $viewUserA ?>"><?= htmlspecialchars($viewUsers['a']['username']) ?></a>
                    <i class="bi bi-arrows-expand mx-2"></i>
                    <a href="/projet/user/profile.php?id=<?= $viewUserB ?>"><?= htmlspecialchars($viewUsers['b']['username']) ?></a>
                </span>
