...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user_id > 0 && $amount > 0) {
        ...
        $success = "FG ajoutés avec succès !";
        // Recharger la liste
        $users = $pdo->query("SELECT id, username, forum_gold FROM users ORDER BY username")->fetchAll();
    }
}
...
<head>
    ...
    <title>Donner des J — Admin</title>
...
<div class="container py-5" style="max-width: 500px;">
    <h3 class="fw-bold mb-4"><i class="bi bi-coin text-warning me-2"></i>Donner des J</h3>
            ...
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-text text-warning fw-bold">FG</span>
                    </div>
                </div>
                <button type="submit" class="btn btn-warning w-100 fw-bold">
                    <i class="bi bi-plus-circle me-1"></i>Ajouter les FG
                </button>
            </form>
        </div>
    </div>

    <!-- Tableau de tous les soldes -->
    ...
    <a href="/projet/admin/index.php" class="btn btn-outline-light btn-sm">← Retour admin</a>
</div>
</div>
