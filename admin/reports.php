                        ...
                        <div class="flex-grow-1">
                            ...
                            <?php if ($report['type'] === 'post' && $report['context']): ?>
                                <div class="bg-light p-2 rounded mb-2">
                                    ...
                                    dans <a href="/finalmaison-main/forum/topic.php?id=<?= $report['context']['topic_id'] ?>"><?= htmlspecialchars($report['context']['topic_title']) ?></a> :</small>
                            ...
                            <?php elseif ($report['type'] === 'user' && $report['context']): ?>
                                <p class="mb-1">
                                    ...
                                    <a href="/finalmaison-main/user/profile.php?id=<?= $report['target_id'] ?>"><?= htmlspecialchars($report['context']['username']) ?></a>
                                </p>
                            <?php elseif ($report['type'] === 'trade' && $report['context']): ?>
                                <p class="mb-1">
                                    <strong>Annonce :</strong>
                                    <a href="/finalmaison-main/trade/trade.php?id=<?= $report['target_id'] ?>"><?= htmlspecialchars($report['context']['title']) ?></a>
                                    par <?= htmlspecialchars($report['context']['username']) ?>
                                </p>
                            <?php endif; ?>

                            <small class="text-muted">
                                Signalé par <a href="/finalmaison-main/user/profile.php?id=<?= $report['reporter_id'] ?>"><?= htmlspecialchars($report['reporter_name']) ?></a>
                        ...
                        <?php if ($report['status'] === 'pending'): ?>
                            <div class="d-flex gap-2 ms-3">
                                ...
                                <?php if ($report['type'] === 'user' && $userRole === 'admin'): ?>
                                    <a href="/finalmaison-main/admin/users.php?search=<?= urlencode($report['context']['username'] ?? '') ?>"
