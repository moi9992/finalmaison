...
if ($q !== '') {
    ...
    // Construire les conditions avec alias
...
// Pagination pour les onglets spécifiques
...
<div class="container my-5">
    ...
    <?php if ($q !== ''): ?>
        ...
        <ul class="nav nav-tabs mb-4">
            ...
            // Recalculer les totaux pour l'onglet "all"
            if ($tab !== 'all') {
                // On a besoin des totaux de toutes les catégories pour l'onglet all
                if ($tab === 'topics') {
            ...
            <div class="mb-5">
                ...
                <div class="list-group">
                    <?php foreach ($topics as $t): ?>
                        <a href="/projet/forum/topic.php?id=<?= $t['id'] ?>" class="list-group-item list-group-item-action">
            ...
            <div class="mb-5">
                ...
                <div class="list-group">
                    <?php foreach ($trades as $t): ?>
                        <a href="/projet/trade/trade.php?id=<?= $t['id'] ?>" class="list-group-item list-group-item-action">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
            ...
            <div class="mb-5">
                ...
                <div class="list-group">
                    <?php foreach ($members as $m): ?>
                        <a href="/projet/user/profile.php?id=<?= $m['id'] ?>" class="list-group-item list-group-item-action <?= $m['is_banned'] ? 'opacity-50' : '' ?>">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
        ...
        <!-- Pagination (onglets spécifiques) -->
        <?php if ($totalPages > 1): ?>
            <nav>
