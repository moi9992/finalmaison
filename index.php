...
<div class="hero-section">
    <div class="container">
        <div class="section-label">🎮 Plateforme de trading et de service</div>
        <h1>HYPERBUSINESS<br><span>TRADE</span></h1>
        <p class="mt-3">La plateforme de trading d'items / services par les joueurs pour les joueurs</p>
        <?php if (!isset($_SESSION['isLog']) || !$_SESSION['isLog']): ?>
            <div class="mt-4 d-flex gap-3 justify-content-center">
                <a href="/projet/auth/register.php" class="btn btn-primary btn-lg">Rejoindre</a>
                <a href="/projet/auth/login.php" class="btn btn-secondary btn-lg">Se connecter</a>
            </div>
        <?php else: ?>
            <div class="mt-4 d-flex gap-3 justify-content-center">
                <a href="/projet/trade/index.php" class="btn btn-primary btn-lg">Voir les annonces</a>
                <a href="/projet/forum/index.php" class="btn btn-secondary btn-lg">Forum</a>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-6">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="/projet/trade/index.php" class="btn btn-sm btn-outline-primary">Voir tout</a>
            </div>
        ...
        <div class="col-lg-6">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="/projet/forum/index.php" class="btn btn-sm btn-outline-primary">Voir tout</a>
            </div>
