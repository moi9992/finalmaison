...
$trade = $pdo->prepare("
    SELECT t.*, u.username, u.reputation, u.role AS owner_role, u.avatar
    FROM trades t
...
<div class="container my-5">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/finalmaison-main/trade/index.php">Trading</a></li>
            ...
            <?php else: ?>
                ...
                <div class="d-flex gap-4 flex-wrap">
                    ...
                    <div>
                        ...
                        <a href="/finalmaison-main/user/profile.php?id=<?= $trade['user_id'] ?>" class="fw-bold text-info text-decoration-none d-flex align-items-center gap-2">
                            <?php if (!empty($trade['avatar'])): ?>
                                <img src="<?= htmlspecialchars($trade['avatar']) ?>" alt="avatar" style="width:24px;height:24px;border-radius:50%;object-fit:cover;">
                            <?php else: ?>
                                <i class="bi bi-person-circle"></i>
                            <?php endif; ?>
                            <?= htmlspecialchars($trade['username']) ?>
                        </a>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="fw-bold d-flex align-items-center gap-2">
                                        <?php if (!empty($offer['avatar'])): ?>
                                            <img src="<?= htmlspecialchars($offer['avatar']) ?>" alt="avatar" style="width:20px;height:20px;border-radius:50%;object-fit:cover;">
                                        <?php else: ?>
                                            <i class="bi bi-person-circle"></i>
                                        <?php endif; ?>
        ...
        <div class="col-md-5">
            ...
            <?php elseif (!isset($_SESSION['isLog']) || !$_SESSION['isLog']): ?>
                <div class="alert alert-info">
                    <a href="/finalmaison-main/auth/login.php">Connecte-toi</a> pour faire une offre.
                </div>
            <?php endif; ?>
        </div>
