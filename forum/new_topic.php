...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($title) && !empty($content)) {
        ...
        header("Location: /projet/forum/topic.php?id=$topic_id");
        exit;
    } else {
...
<div class="container my-5">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/projet/forum/category.php?id=<?= $category_id ?>"><?= htmlspecialchars($category['name']) ?></a></li>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="/projet/forum/category.php?id=<?= $category_id ?>" class="btn btn-secondary">Annuler</a>
                </div>
            </form>
