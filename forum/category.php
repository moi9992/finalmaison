...
<div class="container my-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <?php if (isset($_SESSION['isLog']) && $_SESSION['isLog']): ?>
            <a href="/finalmaison-main/forum/new_topic.php?category_id=<?= $id ?>" class="btn btn-primary">
    ...
    <?php else: ?>
        <div class="list-group mb-4">
            <?php foreach ($topics as $topic): ?>
                <a href="/finalmaison-main/forum/topic.php?id=<?= $topic['id'] ?>" class="list-group-item list-group-item-action py-3">
