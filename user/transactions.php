                            ...
                            <td>
                                <?php if ($isIncoming): ?>
                                    <?php if ($tx['from_user_id']): ?>
                                        <a href="/projet/user/profile.php?id=<?= $tx['from_user_id'] ?>" class="text-decoration-none">
                                    ...
                                    <?php endif; ?>
                                <?php else: ?>
                                    <a href="/projet/user/profile.php?id=<?= $tx['to_user_id'] ?>" class="text-decoration-none">
