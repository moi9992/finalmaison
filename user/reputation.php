...
<div class="container my-5">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/finalmaison-main/user/profile.php?id=<?= $profileId ?>"><?= htmlspecialchars($user['username']) ?></a></li>
                                ...
                                <div>
                                    ...
                                    <?php if ($rep['trade_title']): ?>
                                        <span class="text-muted ms-2">—
                                            <a href="/finalmaison-main/trade/trade.php?id=<?= $rep['trade_id'] ?>" class="text-decoration-none">
