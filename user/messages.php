...
// Marquer les notifs comme lues si demandé
if (isset($_GET['read_notif'])) {
    ...
    // Récupérer la notif pour rediriger vers la bonne page
...
// Liste des conversations (dernier message de chaque interlocuteur)
    ...
    <?php else: ?>
        <div class="list-group">
            <?php foreach ($conversations as $conv): ?>
                <a href="/projet/user/conversation.php?user_id=<?= $conv['other_id'] ?>"
